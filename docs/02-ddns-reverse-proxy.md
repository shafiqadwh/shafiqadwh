...
> ⚠️ **ถ้าเน็ตบ้านเป็น 3BB พอร์ต 80 ขาเข้าถูกบล็อกที่ ISP** — วิธี HTTP-01 ของ
> Let's Encrypt ที่คู่มือทั่วไปใช้กันจึงใช้ไม่ได้เลย ต้องออกใบรับรองด้วย **DNS-01**
> แทน (acme.sh + Cloudflare API) — บน Shafiq-NAS มี wildcard cert อยู่แล้ว
> ไม่ต้องออกใหม่ ดู [บทที่ 7](07-shafiq-nas.md)
