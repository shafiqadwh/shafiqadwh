...
> ⚠️ ปัญหานี้จะกลับมาอีกทุกครั้งที่ไอพีเปลี่ยน ตราบใดที่ยังไม่มีตัวอัปเดตอัตโนมัติ
> ก่อนวันงานให้ตรวจข้อ 9 ซ้ำในเช้าวันงาน และเก็บ token ของ Cloudflare ไว้ใน `.env`
> เท่านั้น (`.gitignore` ครอบอยู่แล้ว) **ห้ามฝังลงโค้ดหรือไฟล์ที่แชร์กัน**
