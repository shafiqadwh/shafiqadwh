...
export const config = {
  ...
  media: {
    ...
    // ภาพปก/รูปงานบนหน้าแรก — แขกทุกคนโหลดไฟล์นี้ตอนเปิดเว็บ ต่างจากรูปในแกลลอรี่
    // ที่โหลดเฉพาะคนที่เลื่อนดู · ที่ 1200 px ได้ราว 160 KB คูณแขกพันคนคือ ~160 MB
    // ขาออกของบ้าน ซึ่งต้องแบ่งกับการอัพโหลดของแขกที่เป็นหน้าที่หลักของระบบ
    hostImageSize: num('HOST_IMAGE_SIZE', 1200),
  ...
  /*
   * เก็บรูปจากบูธไว้กี่วันแล้วลบ (0 = เก็บถาวร)
   *
   * **QR อยู่บนกระดาษของแขกตลอดไป แต่รูปไม่ได้อยู่ตลอดไป** — พ้นกำหนดแล้วไฟล์
   * ถูกลบ แต่แถวยังอยู่เพื่อให้หน้าที่ QR ชี้ไป **บอกได้ว่า "หมดอายุแล้ว"**
   * แทนที่จะบอกว่า "ยังไม่ขึ้นระบบ กลับมาใหม่" ซึ่งกลายเป็นคำโกหกและทำให้แขก
   * รอเก้อไปตลอด · นับจากวันที่รูป **ขึ้นระบบ** ไม่ใช่วันถ่าย เพราะบูธอาจอัปโหลด
   * หลังงานหลายวัน ถ้านับจากวันถ่ายรูปจะหมดอายุตั้งแต่วันแรกที่แขกสแกนได้
   */
  boothRetentionDays: num('BOOTH_RETENTION_DAYS', 7),
